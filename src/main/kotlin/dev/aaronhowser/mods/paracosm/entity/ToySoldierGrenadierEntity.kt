...
class ToySoldierGrenadierEntity : ToySoldierEntity {

	constructor(
		level: Level
	) : this(ModEntityTypes.TOY_SOLDIER_GRENADIER.get(), level)

	constructor(
		entityType: EntityType<ToySoldierGrenadierEntity>,
		level: Level
	...
	companion object {
		val WALK_ANIM: RawAnimation = RawAnimation.begin().thenLoop("animation.toygrenadier.walk")
	}
